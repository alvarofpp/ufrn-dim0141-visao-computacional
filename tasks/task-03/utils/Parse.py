...
class Parse:
    ...
    def __init__(self):
        ...
        opts, args = getopt.getopt(argv, '-h', ['help', 'rho=', 'theta=', 'threshold='])
        self._get_opts(opts)
        self._get_args(args)
    ...
    def get_valid_parameters(self):
        return {key: value for key, value in self.params.items() if value is None}
    ...
    def _get_args(self, args):
        ...
        for arg in args:
            ...
            self.params[keys_empty.pop(0)] = arg
